...
namespace MayCatServer
{
    public class MayMenController
    {
        ...
        public void NapDanhSachDonHang(List<DonHang> donHangs, double heSoSong, bool napViTri1 = true, long sttBatDau = 0)
        {
            try
            {
                if (donHangs != null && MayMenTags.Instance.STT1 != null && MayMenTags.Instance.STT2.Quality == Quality.Good)
                {
        ...
        public void NapGiayMat(List<DonHang> donHangs, long sttMat, bool napViTri1 = true)
        {
            try
            {
                ...
                if (donHangs != null)
                {
                    if (MayMenTags.Instance.STTMat1 != null && MayMenTags.Instance.STTMat1.Quality == Quality.Good)
                    {
        ...
        public void NapDonHang(List<DonHang> donHangs, long sttDon, bool napViTri1 = true )
        {
            if (long.TryParse(CutterTags.Instance.STT1.Value, out long sttCutter) &&
                long.TryParse(MayMenTags.Instance.STT1.Value, out long sttDon1) && MayMenTags.Instance.STT2.Quality == Quality.Good)
            {
