    ...
    public class CutterController
    {
            ...
            try
            {
                if (donHangs != null)
                {
                    if (long.TryParse(CutterTags.Instance.STT1.Value, out long stt))
                    {
                        ...
                        try
                        {
                            if (DanhSachNap != null && DanhSachNap.Count > 0)
                            {
                                DonHang dhDauTien = DanhSachNap[0];
                                if (stt == dhDauTien.STT)
                                {
                                    CutterTags.Instance.Setting1.Write(dhDauTien.Line.ToString());
                                }
                            }
                        }
                        catch { }
        ...
        public int NapDon(DonHang dh, int viTri = 1, int soLanThuToiDa = 1)
        {
            if (dh != null)
            {
                try
                {
                    ...
                    string tagXa = prefix + "STTXa" + viTri;
                    string tagLine = prefix + "Line" + viTri;
                    ...
                    if (viTri >= 1 && viTri <= 3)
                    {
                        ...
                        else
                        {
                            ...
                            writeCommands.Add(new WriteCommand() { PathToTag = tagXa, Value = dh.MayXa.ToString() });
                        }
                        ...
                        writeCommands.Add(new WriteCommand() { PathToTag = tagLine, Value = dh.Line.ToString() });
                        return 1;
                    }
                }
                catch { }
        ...
        public bool SoSanhDonHang(DonHang dh, int viTri)
        {
            if (viTri >= 1 && viTri <= 3 && dh != null)
            {
                ...
                string mayXa = dh.MayXa.ToString();
                string line = dh.Line.ToString();

                ITagCore sttTag = null;
                ITagCore daiCatTag = null;
                ITagCore slTag = null;
                ITagCore palletTag = null;
                ITagCore mayXaTag = null;
                ITagCore lineTag = null;
                ...
                switch (viTri)
                {
                    case 1:
                        ...
                        mayXaTag = CutterTags.Instance.STTXa1;
                        lineTag = CutterTags.Instance.Line1;
                        break;
                    case 2:
                        ...
                        mayXaTag = CutterTags.Instance.STTXa2;
                        lineTag = CutterTags.Instance.Line2;
                        break;
                    case 3:
                        ...
                        mayXaTag = CutterTags.Instance.STTXa3;
                        lineTag = CutterTags.Instance.Line3;
                        break;
                    default:
                        break;
                }
