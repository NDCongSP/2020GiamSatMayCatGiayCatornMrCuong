...
namespace MayCat
{
    ...
    public class ModbusTCPClient
    {
        ...
        public ModbusTCPClient(string ip, ushort port)
        {
        ...
        public ModbusTCPClient(string ip, ushort port, bool no_sync_connection)
        {
